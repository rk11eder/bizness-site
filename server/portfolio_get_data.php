...
$res_select_projectos = $database->query_simple_prepare("SELECT projetos.id, projetos.activo, projetos.logo, projetos.cor, projetos.destaque, projetos_foto.foto FROM ".$database->array_tables[1].", ".$database->array_tables[2]." WHERE " .$database->array_tables[1].".id" ."=". $database->array_tables[2].".id_projeto",array(),"");
