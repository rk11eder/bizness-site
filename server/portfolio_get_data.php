...
$res = $database->query_simple_prepare("SELECT projetos.id, projetos.ativo, projetos.url, projetos.logo, projetos.cor, projetos.destaque FROM ".$database->array_tables[1]. " WHERE projetos.ativo=1 ORDER BY ? ASC " ,array("projetos.ordem"),"s");
