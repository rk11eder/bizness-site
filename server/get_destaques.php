...
foreach ( $res as $key => $value) {
        $res[$key]['imagens'] = $database->query_simple_prepare("SELECT projetos_fotos.foto as imagem FROM projetos_fotos WHERE projetos_fotos.id_projeto=? LIMIT 1 ORDER BY ? ", array($value["id"],"id"), "is");
}
